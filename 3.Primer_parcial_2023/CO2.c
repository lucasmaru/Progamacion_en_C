...
void Busca_extremos(nodo* l, int *maximos[]){
    nodo *actual=NULL;    
    ...
    if(l==NULL){
        ...
        maximos[0]=l->dato.ppm;
        maximos[1]=l->dato.ppm;
        actual=l;
        while(actual!=NULL){
            if(actual->dato.ppm >= maximos[0])//max
                maximos[0]=actual->dato.ppm;
            if(actual->dato.ppm <= maximos[1])//min
                maximos[1]=actual->dato.ppm;
            actual=actual->sig;
        }
    ...
    do{
        ...
        switch(opcion)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                Busca_extremos(lista_m,maximos);
                printf("%d\n",maximos[0]);
                break;
            case 4:
                lista_m =Eliminar_nodo(lista_m,maximos[0]);
                lista_m =Eliminar_nodo(lista_m,maximos[1]);
                Mostrar_lista(lista_m);
                break;
            case 5:
